...
export default function MovieToDay () {
  ...
  return(
    <>
      <div className="col-start-2 col-end-3 h-full w-full p-3 overflow-scroll  text-onSecondaryContainer bg-surfaceVariant shadow-md rounded-xl transition-all duration-300 ease-in-out ">
